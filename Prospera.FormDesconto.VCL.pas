unit Prospera.FormDesconto.VCL;
...
procedure TFormDesconto.btnReceberClick(Sender: TObject);
var
  LIDMovCaixa: string;
...
begin
  ...
  with Prospera.FormPDV.VCL.Pagamento do
  begin
  ...
  begin
    ...
    begin
      ...
      FieldByName('ID_VENDA').AsString :=
        Prospera.FormPDV.VCL.VendaAberta.ID;
